...
2. run cryptogauled with -printalert or -sendalert like this:
   /path/to/cryptogauled -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptogaule.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/cryptogaule Core:0.12.0.58/"));

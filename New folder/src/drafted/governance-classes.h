 ...
 *
 *   // network
 *   CcryptogauleNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cryptogaule.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CcryptogauleNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CcryptogauleNetwork(UniValue objIn)
    {
...
// // can be under: cryptogauleNetwork
// //   -- signature requirements : Key1(User)
// class CcryptogauleNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == cryptogauleNetwork);
//     // }

    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("cryptogaule Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About cryptogaule Core"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the cryptogaule Core help message to get a list with possible cryptogaule Core command-line options"));
...
{
    QString strTitle = tr("cryptogaule Core"); // default title
    ...
    // Append title to "cryptogaule Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

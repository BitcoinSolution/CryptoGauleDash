    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("cryptogaule-light"), QVariant("light"));
    ui->theme->addItem(QString("cryptogaule-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("cryptogaule-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("cryptogaule-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("cryptogaule-traditional"), QVariant("trad"));

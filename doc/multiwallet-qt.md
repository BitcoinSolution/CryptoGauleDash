...
Only requiring some minor changes is cryptogaule.cpp.
...
Changes to cryptogaule.cpp
----------------------
cryptogaule.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

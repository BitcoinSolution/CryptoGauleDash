...
cryptogaule Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as cryptogaule Core, where everyone uses
...
pay attention to for reviewers of cryptogaule Core code.

General cryptogaule Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: cryptogaule Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
This mechanism has been integrated into Bitcore-Node-cryptogaule which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptogaulepay/insight-api-cryptogaule#web-socket-api](https://github.com/cryptogaulepay/insight-api-cryptogaule#web-socket-api)
* API: [https://github.com/cryptogaulepay/insight-api-cryptogaule#instantsend-transactions](https://github.com/cryptogaulepay/insight-api-cryptogaule#instantsend-transactions)
...
By default, the cryptogaule Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the cryptogaule Core daemon:

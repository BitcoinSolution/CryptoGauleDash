...
All the cryptogaule in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 cryptogaule, 0.1 cryptogaule, 1 cryptogaule and 10 cryptogaule -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cryptogaulepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://cryptogaulepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);

...
QT_TRANSLATE_NOOP("cryptogaule-core", ""
"Disable all cryptogaule specific functionality (Masternodes, PrivateSend, "
...
"currently limited to %1 cryptogaule."),
QT_TRANSLATE_NOOP("cryptogaule-core", ""
...
"no limit (default: %d)"),
QT_TRANSLATE_NOOP("cryptogaule-core", ""
"Unable to bind to %s on this computer. cryptogaule Core is probably already running."),
QT_TRANSLATE_NOOP("cryptogaule-core", ""
"Unable to locate enough PrivateSend denominated funds for this transaction."),
QT_TRANSLATE_NOOP("cryptogaule-core", ""
"Unable to locate enough PrivateSend non-denominated funds for this "
"transaction that are not equal 1000 cryptogaule."),
QT_TRANSLATE_NOOP("cryptogaule-core", ""
...
QT_TRANSLATE_NOOP("cryptogaule-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("cryptogaule-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "(default: %s)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "(default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Already have that input."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Block creation options:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Can't mix: no compatible inputs found!"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Collateral not valid."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Copyright (C) 2009-%i The Bitcoin Core Developers"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Copyright (C) 2014-%i The cryptogaule Core Developers"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Could not parse masternode.conf"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Entries are full."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Entry exceeds maximum size."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Error connecting to Masternode."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to load masternode payments cache from"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Input is not valid."),
QT_TRANSLATE_NOOP("cryptogaule-core", "InstantSend options:"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Invalid masternodeprivkey. Please see documenation."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Invalid port detected in masternode.conf"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("cryptogaule-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("cryptogaule-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Keep N cryptogaule anonymized (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Last successful PrivateSend action was too recent."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Line: %d"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading block index..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading governance cache..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading masternode payment cache..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading wallet... (%3.2f %%)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Lock is already in place."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Masternode cache is empty, skipping payments and governance cache..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Masternode options:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("cryptogaule-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("cryptogaule-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("cryptogaule-core", "No errors detected."),
QT_TRANSLATE_NOOP("cryptogaule-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Node relay options:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Port: %d"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Print version and exit"),
QT_TRANSLATE_NOOP("cryptogaule-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("cryptogaule-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("cryptogaule-core", "PrivateSend request incomplete:"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Rebuild chain state from the currently indexed blocks"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Session not complete!"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Session timed out."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Set the masternode private key"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Specify masternode configuration file (default: %s)"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Submitted to masternode, waiting in queue %s"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchroning blockchain..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronization failed"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronization finished"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronization pending..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Synchronizing masternodes..."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Transaction not valid."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Unable to sign spork message, wrong key?"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Unknown response."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Use the test chain"),
QT_TRANSLATE_NOOP("cryptogaule-core", "User Agent comment (%s) contains unsafe characters."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Wallet is locked."),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "Wallet window title"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Warning"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("cryptogaule-core", "Will retry..."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("cryptogaule-core", "Your transaction was accepted into the pool!"),
...
QT_TRANSLATE_NOOP("cryptogaule-core", "no mixing available."),
QT_TRANSLATE_NOOP("cryptogaule-core", "see debug.log for details."),

...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "cryptogauleNetwork") type = cryptogauleNetwork;
    if(strType == "cryptogauleNetworkVariable") type = cryptogauleNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == cryptogauleNetwork) s = "cryptogauleNetwork";
    if(type == cryptogauleNetworkVariable) s = "cryptogauleNetworkVariable";
